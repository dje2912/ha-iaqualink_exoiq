...
class AqualinkToggle(AqualinkSwitch):
    """Aqualink Toggle Device."""
    pass
...
class AqualinkHeater(AqualinkSwitch):
    """Aqualink Heater Device."""

class AqualinkPump(AqualinkSwitch):
    """Aqualink Pump Device."""
